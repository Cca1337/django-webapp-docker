...
#    file_path = '/media/' + filename
    file_path = '/usr/src/app/media/main/media/' + filename
...
#    file_path = '/media/' + str(pic.file)
    file_path1 = '/usr/src/app/media/' + str(pic.file)
    ...
    if pic:
        ...
        if pic.user_id == current_user.id:
            ...
            messages.error(response, f" {pic.name} has been deleted!")
